...
import { BackgroundInfoTabComponent } from './background-info-tab.component';
...
describe('BackgroundInfoTabComponent', () => {
  let component: BackgroundInfoTabComponent;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(BackgroundInfoTabComponent);
