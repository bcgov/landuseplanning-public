...
import { ProjectPhaseTabComponent } from './project-phase-tab.component';
...
describe('ProjectPhaseTabComponent', () => {
  let component: ProjectPhaseTabComponent;
  let fixture: ComponentFixture<ProjectPhaseTabComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ProjectPhaseTabComponent);
